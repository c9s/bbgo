...
func init() {
	rockhopper.AddMigration(upAddPnlColumn, downAddPnlColumn)
}

func upAddPnlColumn(ctx context.Context, tx *sql.Tx) (err error) {
...
func downAddPnlColumn(ctx context.Context, tx *sql.Tx) (err error) {
