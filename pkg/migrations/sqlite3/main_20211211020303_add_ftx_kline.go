...
// This migration was compiled from migrations/sqlite3/20211211020303_add_ftx_kline.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20211211020303, "migrations/sqlite3/20211211020303_add_ftx_kline.sql", false,
