...
func init() {
	rockhopper.AddMigration(upAddKlineTakerBuyColumns, downAddKlineTakerBuyColumns)
}

func upAddKlineTakerBuyColumns(ctx context.Context, tx *sql.Tx) (err error) {
...
func downAddKlineTakerBuyColumns(ctx context.Context, tx *sql.Tx) (err error) {
