// Code generated by "requestgen -method GET -url /api/v1/market -type GetMarketRequest -responseType .Market"; DO NOT EDIT.
 ...
 * Symbol sets
 */
func (g *GetMarketRequest) Symbol(symbol string) *GetMarketRequest {
	g.symbol = symbol
	return g
}
...
func (g *GetMarketRequest) GetPath() string {
