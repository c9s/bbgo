// Code generated by "requestgen -method DELETE -url /api/v1/order -type CancelOrderRequest -responseType .Order"; DO NOT EDIT.
 ...
 * ClientId sets
 */
func (c *CancelOrderRequest) ClientId(clientId uint32) *CancelOrderRequest {
	c.clientId = &clientId
	return c
}
