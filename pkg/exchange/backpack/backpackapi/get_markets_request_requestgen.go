// Code generated by "requestgen -method GET -url /api/v1/markets -type GetMarketsRequest -responseType []Market"; DO NOT EDIT.
...
/*
  - MarketType sets marketType filters the returned markets. The API accepts the parameter more than once;

this request sends at most one value, which covers the useful cases.
Omitting it returns the spot and perp markets.
*/
func (g *GetMarketsRequest) MarketType(marketType MarketType) *GetMarketsRequest {
