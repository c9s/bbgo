// Code generated by "requestgen -method GET -url /api/v1/ticker -type GetTickerRequest -responseType .Ticker"; DO NOT EDIT.
 ...
 * Interval sets
 */
func (g *GetTickerRequest) Interval(interval TickerInterval) *GetTickerRequest {
	g.interval = &interval
	return g
}
 ...
 * Source sets
 */
func (g *GetTickerRequest) Source(source KlineSource) *GetTickerRequest {
	g.source = &source
	return g
}
...
func (g *GetTickerRequest) applySlugsToUrl(url string, slugs map[string]string) string {
	for _k, _v := range slugs {
		...
		if cached, ok := GetTickerRequestSlugReCache.Load(_k); ok {
			needleRE = cached.(*regexp.Regexp)
		} else {
			needleRE = regexp.MustCompile(":" + _k + "\\b")
			GetTickerRequestSlugReCache.Store(_k, needleRE)
		}
