// Code generated by "requestgen -method GET -url /api/v1/trades -type GetTradesRequest -responseType []Trade"; DO NOT EDIT.
...
func (g *GetTradesRequest) Do(ctx context.Context) ([]Trade, error) {
