// Code generated by "requestgen -method GET -url /api/v1/depth -type GetDepthRequest -responseType .Depth"; DO NOT EDIT.
...
/*
 * Limit sets limit is the number of levels to return. If omitted, up to 5000 levels are returned.
 */
func (g *GetDepthRequest) Limit(limit DepthLimit) *GetDepthRequest {
	g.limit = &limit
	return g
}
