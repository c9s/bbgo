// Code generated by "requestgen -method GET -url /api/v1/orders/{orderId} -type GetOrderRequest -responseType .Order"; DO NOT EDIT.
...
func (g *GetOrderRequest) GetSlugParameters() (map[string]interface{}, error) {
	...
	if len(orderId) == 0 {
		return nil, fmt.Errorf("orderId is required, empty string given")
	}
