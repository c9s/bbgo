// Code generated by "requestgen -method POST -url /fapi/v1/multiAssetsMargin -type FuturesChangeMultiAssetsModeRequest -responseType FuturesChangeMultiAssetsModeResponse"; DO NOT EDIT.
...
func (f *FuturesChangeMultiAssetsModeRequest) applySlugsToUrl(url string, slugs map[string]string) string {
...
func (f *FuturesChangeMultiAssetsModeRequest) iterateSlice(slice interface{}, _f func(it interface{})) {
...
func (f *FuturesChangeMultiAssetsModeRequest) isVarSlice(_v interface{}) bool {
...
func (f *FuturesChangeMultiAssetsModeRequest) Do(ctx context.Context) (*FuturesChangeMultiAssetsModeResponse, error) {
	...
	var apiResponse FuturesChangeMultiAssetsModeResponse
