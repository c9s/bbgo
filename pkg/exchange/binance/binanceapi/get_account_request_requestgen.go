// Code generated by "requestgen -method GET -url /api/v3/account -type GetAccountRequest -responseType .SpotAccount"; DO NOT EDIT.
...
func (g *GetAccountRequest) Do(ctx context.Context) (*SpotAccount, error) {
