...
func NewStream(client *okexapi.RestClient, exchange types.Exchange) *Stream {
	stream := &Stream{
		client:         client,
		exchange:       exchange,
		StandardStream: types.NewStandardStream(),
		kLineStream:    NewKLineStream(exchange.(*Exchange)),
	}
...
func (s *Stream) getInstrumentType() okexapi.InstrumentType {
