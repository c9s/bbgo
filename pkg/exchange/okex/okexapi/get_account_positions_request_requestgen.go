// Code generated by "requestgen -method GET -responseType .APIResponse -responseDataField Data -url /api/v5/account/positions -type GetAccountPositionsRequest -responseDataType []Position"; DO NOT EDIT.
...
func (g *GetAccountPositionsRequest) InstType(instType InstrumentType) *GetAccountPositionsRequest {
	g.instType = &instType
	return g
}
...
func (g *GetAccountPositionsRequest) Do(ctx context.Context) ([]Position, error) {
