// Code generated by "requestgen -method GET -responseType .APIResponse -responseDataField Data -url /api/v5/trade/orders-history-archive -type GetOrderHistoriesRequest -responseDataType .OrderList"; DO NOT EDIT.
...
func (g *GetOrderHistoriesRequest) SetInstrumentType(InstrumentType InstrumentType) *GetOrderHistoriesRequest {
	g.InstrumentType = InstrumentType
	return g
}

func (g *GetOrderHistoriesRequest) SetInstrumentID(InstrumentID string) *GetOrderHistoriesRequest {
	g.InstrumentID = &InstrumentID
	return g
}

func (g *GetOrderHistoriesRequest) SetOrderType(OrderType OrderType) *GetOrderHistoriesRequest {
	g.OrderType = &OrderType
	return g
}

func (g *GetOrderHistoriesRequest) SetUnderlying(Underlying string) *GetOrderHistoriesRequest {
	g.Underlying = &Underlying
	return g
}

func (g *GetOrderHistoriesRequest) SetInstrumentFamily(InstrumentFamily string) *GetOrderHistoriesRequest {
	g.InstrumentFamily = &InstrumentFamily
	return g
}

func (g *GetOrderHistoriesRequest) SetState(State OrderState) *GetOrderHistoriesRequest {
	g.State = &State
	return g
}
...
func (g *GetOrderHistoriesRequest) After(after string) *GetOrderHistoriesRequest {
	g.after = &after
	return g
}

func (g *GetOrderHistoriesRequest) Before(before string) *GetOrderHistoriesRequest {
	g.before = &before
	return g
}
...
func (g *GetOrderHistoriesRequest) GetQueryParameters() (url.Values, error) {
	...
	if g.category != nil {
		...
		// TEMPLATE check-valid-values
		switch category {
		case CategoryTwap, CategoryAdl, CategoryFullLiquidation, CategoryPartialLiquidation, CategoryDelivery, CategoryDdh:
...
func (g *GetOrderHistoriesRequest) Do(ctx context.Context) (OrderList, error) {
