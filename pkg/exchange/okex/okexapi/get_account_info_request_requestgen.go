// Code generated by "requestgen -method GET -responseType .APIResponse -responseDataField Data -url /api/v5/account/balance -type GetAccountInfoRequest -responseDataType []Account"; DO NOT EDIT.
...
func (g *GetAccountInfoRequest) Do(ctx context.Context) ([]Account, error) {
