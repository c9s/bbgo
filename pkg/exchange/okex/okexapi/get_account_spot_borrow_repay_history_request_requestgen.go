// Code generated by "requestgen -method GET -responseType .APIResponse -responseDataField Data -url /api/v5/account/spot-borrow-repay-history -type GetAccountSpotBorrowRepayHistoryRequest -responseDataType []BorrowEntryResponse"; DO NOT EDIT.
...
func (g *GetAccountSpotBorrowRepayHistoryRequest) Do(ctx context.Context) ([]BorrowEntryResponse, error) {
