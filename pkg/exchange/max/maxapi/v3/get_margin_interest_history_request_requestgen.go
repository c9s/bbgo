// Code generated by "requestgen -method GET -url /api/v3/wallet/m/interests/history -type GetMarginInterestHistoryRequest -responseType []MarginInterestRecord"; DO NOT EDIT.
...
func (g *GetMarginInterestHistoryRequest) Do(ctx context.Context) ([]MarginInterestRecord, error) {
	...
	apiURL := "/api/v3/wallet/m/interests/history"
