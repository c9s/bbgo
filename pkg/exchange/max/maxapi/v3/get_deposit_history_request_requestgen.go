// Code generated by "requestgen -method GET -url /api/v3/deposits -type GetDepositHistoryRequest -responseType []Deposit"; DO NOT EDIT.
...
func (g *GetDepositHistoryRequest) applySlugsToUrl(url string, slugs map[string]string) string {
	for _k, _v := range slugs {
		...
		if cached, ok := GetDepositHistoryRequestSlugReCache.Load(_k); ok {
			needleRE = cached.(*regexp.Regexp)
		} else {
			needleRE = regexp.MustCompile(":" + _k + "\\b")
			GetDepositHistoryRequestSlugReCache.Store(_k, needleRE)
		}
