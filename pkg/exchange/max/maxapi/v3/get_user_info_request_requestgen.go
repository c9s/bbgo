// Code generated by "requestgen -method GET -url /api/v3/info -type GetUserInfoRequest -responseType .UserInfo"; DO NOT EDIT.
...
func (g *GetUserInfoRequest) iterateSlice(slice interface{}, _f func(it interface{})) {
...
func (g *GetUserInfoRequest) isVarSlice(_v interface{}) bool {
...
func (g *GetUserInfoRequest) Do(ctx context.Context) (*UserInfo, error) {
