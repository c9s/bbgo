// Code generated by "requestgen -method GET -url /api/v3/timestamp -type GetTimestampRequest -responseType .TimestampResponse"; DO NOT EDIT.
...
func (g *GetTimestampRequest) applySlugsToUrl(url string, slugs map[string]string) string {
	for _k, _v := range slugs {
		...
		if cached, ok := GetTimestampRequestSlugReCache.Load(_k); ok {
			needleRE = cached.(*regexp.Regexp)
		} else {
			needleRE = regexp.MustCompile(":" + _k + "\\b")
			GetTimestampRequestSlugReCache.Store(_k, needleRE)
		}
...
func (g *GetTimestampRequest) GetPath() string {
	return "/api/v3/timestamp"
}

// Do generates the request object and send the request object to the API endpoint
func (g *GetTimestampRequest) Do(ctx context.Context) (*TimestampResponse, error) {
	...
	var apiResponse TimestampResponse
