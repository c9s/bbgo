...
func (s *PublicService) Timestamp() (serverTimestamp int64, err error) {
	...
	req, err := s.client.NewRequest(nil, "GET", "v2/timestamp", nil, nil)
	if err != nil {
		return 0, err
	}
...
func (s *PublicService) Markets() ([]Market, error) {
	req, err := s.client.NewRequest(nil, "GET", "v2/markets", url.Values{}, nil)
	if err != nil {
		return nil, err
	}
...
func (s *PublicService) Tickers() (map[string]Ticker, error) {
	...
	req, err := s.client.NewRequest(nil, "GET", endPoint, url.Values{}, nil)
	if err != nil {
		return nil, err
	}
...
func (s *PublicService) KLines(symbol string, resolution string, start time.Time, limit int) ([]KLine, error) {
	...
	req, err := s.client.NewRequest(nil, "GET", fmt.Sprintf("%s/k", s.client.BaseURL), queries, nil)
	if err != nil {
