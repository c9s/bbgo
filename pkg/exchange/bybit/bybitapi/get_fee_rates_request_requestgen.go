// Code generated by "requestgen -method GET -responseType .APIResponse -responseDataField Result -url /v5/account/fee-rate -type GetFeeRatesRequest -responseDataType .FeeRates"; DO NOT EDIT.
