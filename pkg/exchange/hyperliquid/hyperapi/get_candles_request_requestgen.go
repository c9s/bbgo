// Code generated by "requestgen -method POST -responseType .APIResponse -responseDataField Response.Data -url /info -type GetCandlesRequest -responseDataType []KLine"; DO NOT EDIT.
...
func (g *GetCandlesRequest) MetaType(metaType ReqTypeInfo) *GetCandlesRequest {
	g.metaType = metaType
	return g
}

func (g *GetCandlesRequest) SetCandleRequest(CandleRequest CandleRequest) *GetCandlesRequest {
...
func (g *GetCandlesRequest) GetParameters() (map[string]interface{}, error) {
	...
	params["type"] = metaType
	// check CandleRequest field -> json key req
	CandleRequest := g.CandleRequest

	// TEMPLATE check-required
	// END TEMPLATE check-required

	// assign parameter of CandleRequest
	params["req"] = CandleRequest
...
func (g *GetCandlesRequest) Do(ctx context.Context) ([]KLine, error) {
