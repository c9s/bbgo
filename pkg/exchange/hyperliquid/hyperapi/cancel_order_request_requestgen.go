// Code generated by "requestgen -method POST -responseType .APIResponse -responseDataField Response.Data -url /exchange -type CancelOrderRequest -responseDataType CancelResponse"; DO NOT EDIT.
...
func (c *CancelOrderRequest) GetParameters() (map[string]interface{}, error) {
	...
	params["type"] = metaType
	// check cancelOrders field -> json key cancels
	cancelOrders := c.cancelOrders

	// TEMPLATE check-required
	// END TEMPLATE check-required

	// assign parameter of cancelOrders
	params["cancels"] = cancelOrders
...
func (c *CancelOrderRequest) Do(ctx context.Context) (*CancelResponse, error) {
