// Code generated by "requestgen -method POST -responseType .APIResponse -responseDataField Response.Data -url /info -type GetOpenOrdersRequest -responseDataType []OpenOrder"; DO NOT EDIT.
...
func (g *GetOpenOrdersRequest) User(user string) *GetOpenOrdersRequest {
	g.user = user
	return g
}

func (g *GetOpenOrdersRequest) Dex(dex string) *GetOpenOrdersRequest {
	g.dex = &dex
	return g
}

func (g *GetOpenOrdersRequest) MetaType(metaType ReqTypeInfo) *GetOpenOrdersRequest {
	g.metaType = metaType
	return g
}
