// Code generated by "requestgen -method GET -url /products/:product_id/ticker -rateLimiter 1+20/2s -type GetTickerRequest -responseType .Ticker"; DO NOT EDIT.
...
var GetTickerRequestLimiter = rate.NewLimiter(10, 1)
...
func (g *GetTickerRequest) GetPath() string {
	return "/products/:product_id/ticker"
}

// Do generates the request object and send the request object to the API endpoint
func (g *GetTickerRequest) Do(ctx context.Context) (*Ticker, error) {
	if err := GetTickerRequestLimiter.Wait(ctx); err != nil {
		return nil, err
	}
