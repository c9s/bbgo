// Code generated by "requestgen -method GET -url /orders/fills -type GetOrderTradesRequest -responseType .TradeSnapshot"; DO NOT EDIT.
...
func (g *GetOrderTradesRequest) Before(before string) *GetOrderTradesRequest {
	g.before = &before
	return g
}

func (g *GetOrderTradesRequest) After(after string) *GetOrderTradesRequest {
	g.after = &after
	return g
}
