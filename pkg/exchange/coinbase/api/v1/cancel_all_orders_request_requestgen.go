// Code generated by "requestgen -method DELETE -url /orders -rateLimiter 1+20/2s -type CancelAllOrdersRequest -responseType .CancelAllOrdersResponse"; DO NOT EDIT.
...
var CancelAllOrdersRequestLimiter = rate.NewLimiter(10, 1)
...
func (c *CancelAllOrdersRequest) Do(ctx context.Context) (CancelAllOrdersResponse, error) {
	if err := CancelAllOrdersRequestLimiter.Wait(ctx); err != nil {
		return nil, err
	}
	...
	var apiResponse CancelAllOrdersResponse
