// Code generated by "requestgen -type GetOrderTradesRequest -method POST -url /v2/auth/r/order/:symbol::id/trades -responseType []OrderTradeDetail"; DO NOT EDIT.
...
func (g *GetOrderTradesRequest) GetPath() string {
	return "/v2/auth/r/order/:symbol::id/trades"
}
