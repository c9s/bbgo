// Code generated by "requestgen -type GetOrderHistoryRequest -method POST -url /v2/auth/r/orders -responseType []OrderData"; DO NOT EDIT.
...
func (g *GetOrderHistoryRequest) Do(ctx context.Context) ([]OrderData, error) {
