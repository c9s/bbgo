// Code generated by "requestgen -type CancelOrderRequest -method POST -url /v2/auth/w/order/cancel -responseType .CancelOrderResponse"; DO NOT EDIT.
...
func (c *CancelOrderRequest) GetParameters() (map[string]interface{}, error) {
	...
	// check clientOrderIDDate field -> json key cid_date
	clientOrderIDDate := c.clientOrderIDDate

	// TEMPLATE check-required
	if len(clientOrderIDDate) == 0 {
	}
	// END TEMPLATE check-required

	// assign parameter of clientOrderIDDate
	params["cid_date"] = clientOrderIDDate
