// Code generated by "requestgen -type GetFundingInfoRequest -method POST -url /v2/auth/r/info/funding/:key -responseType .FundingInfoResponse"; DO NOT EDIT.
...
func (g *GetFundingInfoRequest) GetSlugParameters() (map[string]interface{}, error) {
	...
	// assign parameter of key
	params["key"] = key

	return params, nil
}

func (g *GetFundingInfoRequest) applySlugsToUrl(url string, slugs map[string]string) string {
...
func (g *GetFundingInfoRequest) iterateSlice(slice interface{}, _f func(it interface{})) {
...
func (g *GetFundingInfoRequest) isVarSlice(_v interface{}) bool {
...
func (g *GetFundingInfoRequest) GetPath() string {
	return "/v2/auth/r/info/funding/:key"
}
...
func (g *GetFundingInfoRequest) Do(ctx context.Context) (*FundingInfoResponse, error) {
	...
	var apiResponse FundingInfoResponse
