// Code generated by "requestgen -type GetTradeHistoryBySymbolRequest -method POST -url /v2/auth/r/trades/:symbol/hist -responseType []OrderTradeDetail"; DO NOT EDIT.
...
func (g *GetTradeHistoryBySymbolRequest) applySlugsToUrl(url string, slugs map[string]string) string {
...
func (g *GetTradeHistoryBySymbolRequest) iterateSlice(slice interface{}, _f func(it interface{})) {
...
func (g *GetTradeHistoryBySymbolRequest) isVarSlice(_v interface{}) bool {
...
func (g *GetTradeHistoryBySymbolRequest) GetPath() string {
	return "/v2/auth/r/trades/:symbol/hist"
}
...
func (g *GetTradeHistoryBySymbolRequest) Do(ctx context.Context) ([]OrderTradeDetail, error) {
	...
	var apiResponse []OrderTradeDetail
