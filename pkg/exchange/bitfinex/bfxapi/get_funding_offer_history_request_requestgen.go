// Code generated by "requestgen -type GetFundingOfferHistoryRequest -method POST -url /v2/auth/r/funding/offers/hist -responseType []FundingOffer"; DO NOT EDIT.
...
func (g *GetFundingOfferHistoryRequest) applySlugsToUrl(url string, slugs map[string]string) string {
...
func (g *GetFundingOfferHistoryRequest) iterateSlice(slice interface{}, _f func(it interface{})) {
...
func (g *GetFundingOfferHistoryRequest) isVarSlice(_v interface{}) bool {
...
func (g *GetFundingOfferHistoryRequest) GetPath() string {
	return "/v2/auth/r/funding/offers/hist"
}
