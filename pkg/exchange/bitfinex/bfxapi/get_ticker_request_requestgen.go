// Code generated by "requestgen -type GetTickerRequest -method GET -url /v2/ticker/:symbol -responseType .TickerResponse"; DO NOT EDIT.
...
func (g *GetTickerRequest) GetPath() string {
	return "/v2/ticker/:symbol"
}

// Do generates the request object and send the request object to the API endpoint
func (g *GetTickerRequest) Do(ctx context.Context) (*TickerResponse, error) {
	...
	var apiResponse TickerResponse
