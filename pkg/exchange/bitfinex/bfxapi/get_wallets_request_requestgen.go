// Code generated by "requestgen -type GetWalletsRequest -method POST -url /v2/auth/r/wallets -responseType []WalletResponse"; DO NOT EDIT.
...
func (g *GetWalletsRequest) applySlugsToUrl(url string, slugs map[string]string) string {
...
func (g *GetWalletsRequest) iterateSlice(slice interface{}, _f func(it interface{})) {
...
func (g *GetWalletsRequest) isVarSlice(_v interface{}) bool {
...
func (g *GetWalletsRequest) Do(ctx context.Context) ([]WalletResponse, error) {
	...
	var apiResponse []WalletResponse
