// Code generated by "requestgen -type GetPairConfigRequest -method GET -url /v2/conf/pub:info:pair -responseType PairConfigResponse"; DO NOT EDIT.
...
func (g *GetPairConfigRequest) applySlugsToUrl(url string, slugs map[string]string) string {
...
func (g *GetPairConfigRequest) iterateSlice(slice interface{}, _f func(it interface{})) {
...
func (g *GetPairConfigRequest) isVarSlice(_v interface{}) bool {
...
func (g *GetPairConfigRequest) Do(ctx context.Context) (*PairConfigResponse, error) {
	...
	var apiResponse PairConfigResponse
