// Code generated by "requestgen -type GetSummaryRequest -method POST -url /v2/auth/r/summary -responseType .SummaryResponse"; DO NOT EDIT.
...
func (g *GetSummaryRequest) applySlugsToUrl(url string, slugs map[string]string) string {
...
func (g *GetSummaryRequest) iterateSlice(slice interface{}, _f func(it interface{})) {
...
func (g *GetSummaryRequest) isVarSlice(_v interface{}) bool {
