// Code generated by "requestgen -type GetActiveFundingOffersRequest -method POST -url /v2/auth/r/funding/offers/:symbol -responseType []FundingOffer"; DO NOT EDIT.
...
func (g *GetActiveFundingOffersRequest) applySlugsToUrl(url string, slugs map[string]string) string {
...
func (g *GetActiveFundingOffersRequest) iterateSlice(slice interface{}, _f func(it interface{})) {
...
func (g *GetActiveFundingOffersRequest) isVarSlice(_v interface{}) bool {
...
func (g *GetActiveFundingOffersRequest) GetPath() string {
	return "/v2/auth/r/funding/offers/:symbol"
}
