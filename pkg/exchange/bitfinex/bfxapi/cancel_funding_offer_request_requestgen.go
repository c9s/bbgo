// Code generated by "requestgen -type CancelFundingOfferRequest -method POST -url /v2/auth/w/funding/offer/cancel -responseType .CancelFundingOfferResponse"; DO NOT EDIT.
...
func (c *CancelFundingOfferRequest) applySlugsToUrl(url string, slugs map[string]string) string {
...
func (c *CancelFundingOfferRequest) iterateSlice(slice interface{}, _f func(it interface{})) {
...
func (c *CancelFundingOfferRequest) isVarSlice(_v interface{}) bool {
...
func (c *CancelFundingOfferRequest) GetPath() string {
	return "/v2/auth/w/funding/offer/cancel"
}
...
func (c *CancelFundingOfferRequest) Do(ctx context.Context) (*CancelFundingOfferResponse, error) {
	...
	var apiResponse CancelFundingOfferResponse
