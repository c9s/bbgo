// Code generated by "requestgen -type CloseFundingRequest -method POST -url /v2/auth/w/funding/close -responseType .CloseFundingResponse"; DO NOT EDIT.
...
func (c *CloseFundingRequest) applySlugsToUrl(url string, slugs map[string]string) string {
...
func (c *CloseFundingRequest) iterateSlice(slice interface{}, _f func(it interface{})) {
...
func (c *CloseFundingRequest) isVarSlice(_v interface{}) bool {
...
func (c *CloseFundingRequest) GetPath() string {
	return "/v2/auth/w/funding/close"
}
...
func (c *CloseFundingRequest) Do(ctx context.Context) (*CloseFundingResponse, error) {
	...
	var apiResponse CloseFundingResponse
